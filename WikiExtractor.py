...
def clean(text):
    ...
    text = re.sub(r'{{bd\|(.*?)\|(.*?)\|\|\|.*?}}', r'\1\2~', text) # {{bd|1953年|3月16日|||Stallman}}
    text = re.sub(r'{{bd\|(.*?)\|(.*?)\|(.*?)\|(.*?)\|.*?}}', r'\1\2~\3\4', text) # {{bd|1866年|11月12日|1925年|3月12日|catIdx=S孫}}
    text = re.sub(r'{{bd\|(.*?)\|\|(.*?)\|.*?}}', r'\1~\2', text) # {{bd|1640年||1715年|catIdx=Pu,蒲}}
    text = re.sub(r'{{bd\|(.*?)\|(.*?)\|\|}}', r'\1\2~', text) # {{bd|1969年|12月28日||}}
    text = re.sub(r'{{bd\|(.*?)\|(.*?)\|(.*?)\|(.*?)}}', r'\1\2~\3\4',text) # {{bd|1882年|7月2日|1962年|9月21日}}
    text = re.sub(r'{{bd\|(.*?)\|(.*?)\|(.*?)}}', r'\1\2~',text) #{{bd|1938年|1月10日|catIdx=G高}}
